...
return [
    ...
    'description' => [
         ...
         */
        'fallback' => 'Catalog, browse and share your vinyl record collection with SpinList.',
    ],
    ...
    'image' => [
         ...
         */
        // TODO: replace with a purpose-built default OG image (1200×630).
        'fallback' => '/icons/512.png',
    ],
